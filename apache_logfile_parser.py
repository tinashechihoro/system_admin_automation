...
This script takes one command argument: the name of the log file
to parse.I then parses the log file and generate a report which
...
def dictify_logline(line):
	...
	Currently ,the only fields we  are interested in are remote hosts and bytes send,
...
if '__name__' == '__main__':
	...
	try:
		infile_name = open(infile_name,'r')
	except IOError:
		print('You must specify a valid file to parse')
		print(__doc__)
		sys.exit(1)
	log_report = generate(infile_name)
	print(log_report)
	infile_name.close()
